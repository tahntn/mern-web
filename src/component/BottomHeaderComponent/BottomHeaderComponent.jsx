...
const BottomHeaderComponent = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (prevScrollPos > currentScrollPos) {
        ...
        setIsBgTrans(true);
        setIsBgDark(true);
        setIsShowTopHeader(true);
      }
      if (currentScrollPos < 10) {
        setVisible(true);
        setIsBgTrans(false);
        setIsBgTrans(false);
        setIsShowTopHeader(false);
      }
  ...
  }, [prevScrollPos, visible, setVisible, isBgTrans]);
  ...
  const styleSignUp = {
    borderColor: isHoverSignup ? (isBgTrans ? "white" : "black") : "#868e96",
  };
  ...
  const styleTextSignUp = {
    color: isHoverSignup ? (isBgTrans ? "white" : "black") : "#868e96",
  };
  ...
  return (
    <>
      <div
        className={visible ? "testheader" : "testheadrer hidden "}
        style={
          isBgTrans ? { background: "#000" } : { background: "transparent" }
        }
      >
        <div className={isShowTopHeader ? "hidden" : "hi"}>
          <TopHeaderComponent />
          {/* <Divider /> */}
        </div>
              ...
              <Row gutter={[16, 24]} align="middle" className="">
                {list.map((item) => (
                  <Col
                    key={item.name}
                    style={
                      isBgTrans ? { color: "#868e96" } : { color: "#868e96" }
                    }
                  >
                    <NavLink
                      to={item.path}
                      ...
                      className={
                        isBgTrans
                          ? "text-xl font-medium hover:text-white"
                          : "text-xl font-medium hover:text-black"
                      }
                      style={({ isActive }) =>
                        isActive
                          ? isBgTrans
            ...
            <Col xl={6} lg={8} md={6} sm={0} xs={0}>
              ...
              >
                <input
                  ...
                  className={
                    isBgTrans
                      ? "text-lg relative text-white placeholder-white"
                      : "text-lg relative"
                  }
                  style={{
                    border: "none",
