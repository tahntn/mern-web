...
import { Checkbox, Slider, Radio, Rate } from "antd";
...
const CategoryComponent = ({ handleChangePage }) => {
    ...
    <>
      <div className="category-comp bg-white rounded-xl p-3">
        <div className="flex justify-center">
          <ButtonComponent textButton={"Xóa tất cả"} onClick={onClickReset} className="w-9/12"/>
        </div>
        <div style={styleDiv}>
          <h5 className="text-2xl " style={styleH1}>Danh mục sản phẩm </h5>
          <div style={{
        ...
        <div style={{marginBottom: "40px"}} style={styleDiv}>
          <h5 className="text-2xl " style={styleH1} >Giá</h5>
          <Slider
            range
        ...
        <div style={styleDiv}>
          <h5 className="text-2xl " style={styleH1}>Đánh giá sản phẩm</h5>
          <Radio.Group onChange={onChangeRate} value={rate} className="flex flex-col-reverse">
            <Radio value={1}><Rate disabled defaultValue={1} style={{fontSize: "16px"}}/></Radio>
            <Radio value={2}><Rate disabled defaultValue={2} style={{fontSize: "16px"}} /></Radio>
            <Radio value={3}><Rate disabled defaultValue={3} style={{fontSize: "16px"}}/></Radio>
            <Radio value={4}><Rate disabled defaultValue={4} style={{fontSize: "16px"}}/></Radio>
            <Radio value={5}><Rate disabled defaultValue={5} style={{fontSize: "16px"}}/></Radio>
          </Radio.Group>
        </div>
        <div style={{paddingTop: "20px"}}>
          <h5 className="text-2xl " style={styleH1}>Dành cho</h5>
          <Checkbox.Group onChange={onChangeGender} value={gender} className="flex flex-col">
